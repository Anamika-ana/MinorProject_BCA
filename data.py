# Import custom functions for mediapipe operations
...
with mp_hands.Hands(
    ...
    # Looping through each action, sequence, and frame to capture data
    for action in actions:
        for sequence in range(no_sequences):
            for frame_num in range(sequence_length):
                ...
                # Displaying the collection statuss
                ...
                # Extracting and saving keypoints
