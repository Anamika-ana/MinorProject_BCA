from function import *  # Import custum helper functions
...
from keras.callbacks import TensorBoard  # For loging and monitoring training progress
import numpy as np
import os
...
model.save('model.h5')  # Saving model weights
