# Import custom functions for mediapipe and other operations
...
from keras.callbacks import TensorBoard  # For monitoring and visualiation of training
...
# Setting colours different actionsfor visualisation
...
# Detecting  and displaying variables.
...
# Initializing mediapippe for hand tracking.
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        # Processing and croping the frame for hand detection
        ...
        # Extracting keypoints from the detected hand landmarkss.
        ...
        try:
            ...
            if len(sequence) == 30:
                ...
                if len(sentence) > 1:
                    # Keeep only the most recent action,
                    sentence = sentence[-1:]
                    accuracy = accuracy[-1:]

        except Exception as e:
            pass  # Handling exceptions during prediction
